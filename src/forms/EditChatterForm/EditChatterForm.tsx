...
import {
  EditChatterFormData,
  EditChatterFormProps,
} from './EditChatterForm.types';
import { validators } from './EditChatterForm.data';
...
const EditChatterForm = ({
  ...
  } = useForm<EditChatterFormData>({
    defaultValues: {
      name: currentChatter.name,
      avatar: currentChatter.avatar,
      //isVerified: currentChatter.isVerified,
      isBanned: currentChatter.isBanned,
    },
  });
  ...
  return (
    ...
    >
      <div className='w-full border-b border-gray-100'>
        <H3 className='px-6 py-5'>Edit {currentChatter.name} Chatter</H3>
      </div>
