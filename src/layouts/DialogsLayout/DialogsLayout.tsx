...
const DialogsLayout = () => {
  ...
  return (
    <div className='p-4 w-full h-full flex'>
      <div className='max-w-80 w-full h-full p-4 flex flex-col border bg-white border-gray-200 rounded-xl'>
        ...
        <div className='flex flex-col gap-3 overflow-auto'>
          {chats.map((chat) => (
            <div
              key={chat.partner_id}
              className='flex items-center gap-3 cursor-pointer hover:bg-gray-150 rounded-xl p-2'
              onClick={() => {
